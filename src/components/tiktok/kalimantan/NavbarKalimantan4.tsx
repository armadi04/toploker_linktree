...
import { kalimantanLinks } from "./TiktokKalimantan";
...
const NavbarKalimantan4: React.FC = () => {
  const [searchActive, setSearchActive] = useState(false);
  const [searchValue, setSearchValue] = useState("");
  const [selectedAccount, setSelectedAccount] = useState<City | null>(null);
  ...
  const filteredCities = kalimantanLinks.filter(
    (city: City) =>
...
export default NavbarKalimantan4;
